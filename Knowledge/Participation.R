...
load("/Users/JenniferLin/Desktop/Working/ANES/DS0001/anes2016.rda")
...
anes2016$talk <- as.numeric(as.factor(anes2016$V162010), na.rm = TRUE)
str(anes2016$talk)
...
anes2016$meeting = as.numeric(as.factor(anes2016$V162011))
...
#Contact US Representative or Senator
